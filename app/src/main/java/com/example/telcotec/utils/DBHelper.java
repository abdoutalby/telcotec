...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("Create Table calls (id INTEGER primary key AUTOINCREMENT ,date Date , number Text , operator Text , duration Text , type Text )");
    ...
    public Boolean saveCall(CallData call) {
        ...
        contentValues.put("operator", call.getName());
